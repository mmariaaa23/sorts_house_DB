...
class Apartment:
    def __init__(self, total_area:float, house_number:int, apartment_number:int, owner_name:str, residents_number:int):
...
for i in range(len(df_1)):
    mas_1.append(
        Apartment(df_1['total_area'][i], df_1['house_number'][i], df_1['apartment_number'][i], df_1['owner_name'][i],
...
for i in range(len(df_2)):
    mas_2.append(
        Apartment(df_2['total_area'][i], df_2['house_number'][i], df_2['apartment_number'][i], df_2['owner_name'][i],
...
for i in range(len(df_3)):
    mas_3.append(
        Apartment(df_3['total_area'][i], df_3['house_number'][i], df_3['apartment_number'][i], df_3['owner_name'][i],
...
for i in range(len(df_4)):
    mas_4.append(
        Apartment(df_4['total_area'][i], df_4['house_number'][i], df_4['apartment_number'][i], df_4['owner_name'][i],
...
for i in range(len(df_5)):
    mas_5.append(
        Apartment(df_5['total_area'][i], df_5['house_number'][i], df_5['apartment_number'][i], df_5['owner_name'][i],
...
for i in range(len(df_6)):
    mas_6.append(
        Apartment(df_6['total_area'][i], df_6['house_number'][i], df_6['apartment_number'][i], df_6['owner_name'][i],
...
for i in range(len(df_7)):
    mas_7.append(
        Apartment(df_7['total_area'][i], df_7['house_number'][i], df_7['apartment_number'][i], df_7['owner_name'][i],
